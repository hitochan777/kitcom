<div class="actions columns large-2 medium-3">
	...
	<ul class="side-nav">
		...
		<li><?= $this->Form->postLink(__('Delete Past Exam Solution'), ['action' => 'delete', $pastExamSolution->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pastExamSolution->id)]) ?> </li>

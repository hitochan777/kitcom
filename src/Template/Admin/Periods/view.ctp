...
<div class="actions">
	...
	<ul>
		...
		<li><?= $this->Form->postLink(__('Delete Period'), ['action' => 'delete', $period->id], ['confirm' => __('Are you sure you want to delete # %s?', $period->id)]) ?> </li>
...
<div class="related">
	...
	<?php if (!empty($period->time_tables)): ?>
	<table cellpadding="0" cellspacing="0">
		...
		<?php foreach ($period->time_tables as $timeTables): ?>
		<tr>
